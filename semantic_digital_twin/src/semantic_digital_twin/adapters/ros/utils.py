...
def is_ros2_message(obj: Any) -> bool:
    ...
    :return: True if the object is from a ROS 2 message module; False
        otherwise.
    """
...
def is_ros2_message_class(clazz: Type) -> bool:
    """
    Checks if a class is a ROS2 message based on its slots and field types and
    hope nothing else has the same.
