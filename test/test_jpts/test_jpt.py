...
from random_events.product_algebra import SimpleEvent, VariableSet
from random_events.variable import Variable, Continuous, Integer as IntegerVariable

from probabilistic_model.distributions import GaussianDistribution, BernoulliDistribution
...
from probabilistic_model.probabilistic_circuit.relational.rspns import ExchangeableDistributionTemplate
...
class RSPNTestCase(unittest.TestCase):
    ...
    def test_edt(self):
        variables = [IntegerVariable("X1"), IntegerVariable("X2"), IntegerVariable("X3"), IntegerVariable("X4")]
        pc = ExchangeableDistributionTemplate(variables, BernoulliDistribution, p=0.7)()

        assignment = {variables[0]: 1, variables[1]: 1, variables[2]: 1, variables[3]: 1}
